...
List<String> optionsList = [
  ...
  'Spongegar',
  'Squidward', 'Star-Wars-No', 'Star-Wars-Yoda', 'Stephen-Harper-Podium',
  'Steve-Harvey', 'Steve-Jobs', 'Stoner-Dog', 'Stoner-PhD', 'Stop-Cop',
  'Storytelling-Grandpa', 'Subtle-Pickup-Liner', 'Success-Kid', 'Success-Kid-Girl',
  'Success-Kid-Original',
  'Successful-Black-Man', 'Sudden-Clarity-Clarence', 'Sudden-Disgust-Danny',
  'Super-Birthday-Squirrel', 'Super-Cool-Ski-Instructor', 'Super-Kami-Guru-Allows-This',
  'Superior-Wadsworth', 'Surpised-Frodo', 'Surprised-CatMan', 'Surprised-Coala', 'Surprised-Koala',
  'Surprised-Pikachu',
  'Surprized-Vegeta',
  'Suspicious-Cat',
